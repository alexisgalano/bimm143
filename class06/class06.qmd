...
Funcions are how we get stuff done. We call functions to do everything useful in R.
...
# Set MARGIN = 1 for grading rows, MARGIN = 2 for grading columns. Here we want to grade the student so we will use MARGIN = 1.
```
```{r}
