...
AlphaFold has changed the game for protein structure preditions and allows anyone with sufficient bioinformatics knowledge to predict the structure of virtually any protein.

We ran AlphaFold via GoogleCollab:
...
With this data we can analyze these predicted structures, interpret new interactions, and to get to know each protein of interest in sufficient detail.
